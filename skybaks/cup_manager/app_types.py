...
class TeamPlayerScore:
    ...
    def team_score_str(self) -> str:
        return (
            times.format_time(int(self.team_score))
            if self.team_score_is_time
            else str(self.team_score)
        )

    @property
    def player_score_str(self) -> str:
        return (
            times.format_time(int(self.player_score))
            if self.player_score_is_time
            else str(self.player_score)
        )

    @property
    def player_score2_str(self) -> str:
        return (
            times.format_time(int(self.player_score2))
            if self.player_score2_is_time
            else str(self.player_score2)
        )
